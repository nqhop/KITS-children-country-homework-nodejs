...
class Collection20Exercise {
    ...
    // 12. Tạo một TreeMap chứa các từ và tần suất xuất hiện của chúng trong một
    // đoạn văn bản.
    public static void frequencyInTreeMap(String text) {
        TreeMap<String, Integer> arr = new TreeMap<>();
        System.out.println(text);
        text = text.replaceAll("\\s", "");
        text = text.toLowerCase();
        for (String c : text.split("")) {
            arr.put(c, (arr.get(c) == null) ? 1 : arr.get(c) + 1);
        }
    ...
    public static void findCharactorInLinkedList(LinkedList<String> arr, String i) {
        int count = 0;
        String p = arr.poll();
        while (p != null) {
            if (p == i)
        ...
        System.out.println("the frequency of '" + i + "' in linkedlist: " + count);
    }

    // 14. Kiểm tra xem một ArrayList có rỗng hay không.
    public static void checkEmplyOfArrayList(List<Integer> arr) {
        System.out.println("Is arrayList emplty? " + (arr.isEmpty()));
    }

    // 15. Viết một phương thức để chèn một phần tử vào một ArrayList tại vị trí xác
    // định.
    public static void InsertAnElmenentIntoArrayList(List<Integer> arr, int index, int n) {
        if (index > arr.size())
            arr.add(n);
        else
            arr.add(index, n);
    ...
    // 16. Tạo một PriorityQueue từ một ArrayList và in ra tất cả các phần tử theo
    // thứ tự ưu tiên.
    ...
    public static void sortLinkedList(LinkedList<Integer> arr) {
        Collections.sort(arr);
        System.out.println(arr);
    }

    // 19. Tạo một HashSet từ một mảng và in ra tất cả các phần tử.
    public static void createHashSetFromArray(List<Integer> arr) {
        HashSet<Integer> result = new HashSet<>(arr);
        System.out.println("Hashset " + result);
    }

    // 20. Viết một phương thức để lấy phần tử đầu tiên và phần tử cuối cùng của một
    // ArrayList.
    public static void getFirstAndLastElementInArrayList(List<Integer> arr) {
        System.out.println("First: " + arr.get(0));
        System.out.println("Last: " + arr.get(arr.size() - 1));
    }

    public static void main(String[] args) {
        List<Integer> arr01 = new ArrayList<>(List.of(8, 1, 2, 3, 4, 5));
        ...
        LinkedList<Integer> arr07 = new LinkedList<>(List.of(6, 2, 1, 8, 3, 5));
        ...
        switch (Integer.parseInt(args[0])) {
            ...
            case 10:
                ...
                break;
            case 12:
                frequencyInTreeMap("Hello java");
                break;
            case 13:
                findCharactorInLinkedList(arr02, "e");
                break;
            case 14:
                checkEmplyOfArrayList(arr01);
                break;
            case 15:
                InsertAnElmenentIntoArrayList(arr01, 6, 99);
                break;
            case 16:
                priorityQueueOfArrayList(arr01);
                break;
            case 17:
                checkArrayListContainAllElementOtherInList(arr01, arr06);
                break;
            case 18:
                sortLinkedList(arr07);
                break;
            case 19:
                createHashSetFromArray(arr01);
                break;
            case 20:
                getFirstAndLastElementInArrayList(arr01);
                break;
